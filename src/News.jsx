...
const News = () => {
	const events = [
		...
		},
		{
			...
			description: (
				<>
					Attended the Salesforce Futureforce Tech Accelerator 2025, an
					invite-only 3-day event hosted at Salesforce HQ in San Fransisco.
				</>
			),
		},
		{
			...
			description: (
				<>
					...
					<a
						href="https://devpost.com/software/renaissance-research?_gl=1*1i2txri*_gcl_au*MTU1ODI0MzQ5My4xNzQ1OTEwMjMw*_ga*MTA5NDUzOTk2OS4xNzQ1OTEwMjMw*_ga_0YHJK3Y10M*MTc0NTkxMzM3My4yLjAuMTc0NTkxMzM3My4wLjAuMA.."
						target="_blank"
						rel="noopener noreferrer"
					>
						here
					</a>{" "}
					and our live website{" "}
					<a
						href="https://renresearch.co"
						target="_blank"
						rel="noopener noreferrer"
					>
						here
	...
	return (
		<section className="section" id="news">
			<h1 className="section-title" data-animate>
				<span className="title-hash">#</span> News
			</h1>
